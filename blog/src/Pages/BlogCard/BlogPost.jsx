        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-lg">
          <div className="mb-6">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">
              Fitness: A Journey to Strength and Wellness
            </h1>
          ...
          <img 
            ...
            alt="Fitness Journey" 
            className="rounded-lg w-full h-72 object-cover mb-6 transform transition-transform hover:scale-105 duration-500" 
          />
          
          <p className="text-gray-700 mb-4">
            Achieving fitness is not just about working out, it's about making lifestyle changes that promote overall well-being. Discover the keys to staying motivated and consistent on your fitness journey.
          </p>
          <p className="text-gray-700 mb-4">
